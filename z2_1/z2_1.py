...
# Переименовывание колонок (сохраняя в dataframe)
df.rename(columns={
    'Run1 (ms)': 'run1',
    'Run2 (ms)': 'run2',
    'Run3 (ms)': 'run3',
...
# Добавление колонки со случайными строковыми значениями, т.к. в исходном наборе данных такой не было
...
# Сохранение dataframe с применёнными фильтрами в файл
